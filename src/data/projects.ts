...
export const projects: Project[] = [
  ...
  "detailedDescription": "Fintel A.I. is an advanced agentic decision support platform specialized for the Indian financial ecosystem. It features a real-time mobile application that automates UPI expense tracking by processing SMS notifications through specialized AI agents, utilizing SQLCipher for high-grade local data encryption. The platform utilizes a multi-agent framework (Concurrent & Sequential Swarms) to parallelize complex tasks including transaction classification, budget optimization, and cashflow analysis. \n\nBeyond personal finance, Fintel serves as a high-performance investment engine architected with a Model Context Protocol (MCP) driven agentic tool selection layer. This unified layer enables autonomous agents to perform fundamental and technical analysis, execute quantitative backtesting using Modern Portfolio Theory (MPT) and Monte Carlo simulations, and monitor SEBI-aware risk and compliance metrics (Ind-AS, Companies Act 2013) for Indian equities and mutual funds. \n\nTechnical Presentation: https://www.canva.com/design/DAG5_nGzA9E/xjAos89R6OImdoqZItYeEg/view"
},
  {
    slug: 'doccrypt',
