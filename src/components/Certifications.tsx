...
const Certifications: React.FC = () => {
  return (
    <section id="certifications" className="py-10 bg-sys-background px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h3 className="text-[clamp(1.5rem,4vw,2.5rem)] font-extrabold text-sys-primary mb-8 sm:mb-12 relative pb-2 inline-block">
            ...
            const CardInner = (
              <div className="flex items-center gap-3 sm:gap-2">
                ...
                <div className="avatar shrink-0">
                  <div className="bg-sys-card w-10 sm:w-12 lg:w-14 rounded-full overflow-hidden outline outline-offset-2 outline-base-content/40 group-hover:outline-sys-primary-content">
                    <img
                      loading="lazy"
                ...
                <div className="flex-1 min-w-0 flex flex-col ml-2 sm:ml-4">
                  <h2 className="font-bold text-sys-card-foreground group-hover:text-sys-primary-foreground sm:text-lg lg:text-xl leading-tight line-clamp-2">
                    {item.post}
                  </h2>
                  ...
                  {item.technologies?.length > 0 && (
                    <ul className="mt-2 flex flex-wrap gap-1">
                      {item.technologies.slice(0, 6).map((t) => (
                        <li
                          key={t}
                          className="px-2 py-0.5 bg-sys-secondary/20 group-hover:bg-sys-secondary/40 text-sys-foreground group-hover:text-sys-primary-foreground rounded text-[0.7rem] sm:text-xs"
                        >
                          {t}
                        </li>
                      ))}
              ...
              <li key={item.slug} className="h-full w-full">
                {hasLink ? (
                  <a
                    ...
                    className="duration-200 group border-2 border-sys-primary text-sys-primary flex items-center h-full w-full justify-between p-3 sm:p-4 hover:bg-sys-primary hover:text-sys-primary-foreground hover:shadow-2xl hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sys-primary"
                  ...
                  <div
                    className="group flex items-center bg-sys-primary/50 h-full w-full justify-between p-3 sm:p-4 opacity-90 cursor-not-allowed"
                    aria-disabled="true"
