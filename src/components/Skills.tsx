...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'LangGraph', icon: skill_badges_mono.langgraph },
      { name: 'Gradio', icon: skill_badges.gradio },
      { name: 'CrewAI', icon: skill_badges.crewai },
      ...
      { name: 'Seaborn', icon: skill_badges.seaborn },
    ],
  },
];
